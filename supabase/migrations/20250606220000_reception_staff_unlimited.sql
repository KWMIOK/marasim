-- Allow 0 reception staff limit (= unlimited devices)

ALTER TABLE public.reception_sessions
  ALTER COLUMN reception_staff_limit SET DEFAULT 0;
...
ALTER TABLE public.reception_sessions
  ...
  CHECK (reception_staff_limit >= 0 AND reception_staff_limit <= 20);
